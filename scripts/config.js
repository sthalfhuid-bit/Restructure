const overviewSections = [
  ...
  { key: "health", title: "Sport", dot: "mint", icon: "🏃" },
  { key: "groceries", title: "Boodschappen", dot: "mint", icon: "🛒" },
  { key: "stuff", title: "Mijn spullen", dot: "gold", icon: "🔑" },
  { key: "appointments", title: "Afspraken", dot: "blue", icon: "📅" },
  { key: "tasks", title: "Taken", dot: "mint", icon: "📝" },
  { key: "ideas", title: "Ideeën", dot: "lavender", icon: "💡" },
  { key: "other", title: "Overig", dot: "lavender", icon: "📌" },
];

const CACHE_NAME = "restructure-v3";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css",
  "./manifest.json",
  "./assets/restructure-mark-teal-transparent.png",
  "./assets/restructure-mark-monochrome.png",
...
self.addEventListener("push", (event) => {
  const fallback = {
    title: "Restructure",
    body: "Dit is een rustige testmelding van Restructure.",
    url: "./index.html"
  };
  let data = fallback;
  if (event.data) {
